    ...
    <article>
      <div>
        <div className={styles['example-scroll-pane']}>
          ...
          <h5>&ldquo;There is no one who loves pain itself, who seeks after it and wants to have it, simply because it is
            pain...&rdquo;</h5>
          ...
          <div>Generated 20 paragraphs, 1713 words, 11555 bytes of <a
            href="https://www.lipsum.com/" title="Lorem Ipsum">Lorem Ipsum</a></div>
        </div> {/* /.example-scroll-pane */}
      </div>
    </article>
  </section>;
}
